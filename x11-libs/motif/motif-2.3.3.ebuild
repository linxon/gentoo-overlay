...
inherit autotools eutils flag-o-matic multilib toolchain-funcs multilib-minimal rpm

DESCRIPTION="The Motif user interface component toolkit"
HOMEPAGE="https://sourceforge.net/projects/motif/
	http://motif.ics.com/"

SRC_URI="http://vault.centos.org/6.9/os/Source/SPackages/openmotif-${PV}-9.el6.src.rpm"
